...
5. GitHub will give you a live URL, usually `https://<your-username>.github.io/HoloHouse/`, within a minute or two.

## No-git upload option
If you don't want to use the command line:
1. Create a new repo on GitHub named `HoloHouse`.
2. On the repo page, click **Add file → Upload files**.
3. Drag in `index.html` (and this `README.md` if you want it) and commit.
